                        ...
                        <div class="container">
                            <div class="row m-b-lg">
                                <div class="col-lg-12 text-center">
                                    ...
                                    <h1>Bienvenido</h1>
                                    <p>En ésta sección podrá obtener una guía rápida acerca de Proveneet. Haga clic
                                        sobre cada pregunta para visualizar la respuesta</p>
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq1" class="faq-question">¿Qué es
                                            Proveneet?</a>
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq2" class="faq-question">¿Cómo registro un
                                            nuevo usuario?</a>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div id="faq2" class="panel-collapse collapse ">
                                            <div class="faq-answer">
                                                <p>
                                                    Diríjase a "Ajustes de usuario" en el menú de la izquierda,
                                                    cliqueelo y seleccione
                                                    "Gestión de usuarios" en el menú desplegable, en la parte inferior
                                                    de la tabla de
                                                    usuarios registrados presione "agregar" y rellene los datos
                                                    correspondientes.
                                                </p>
                                            </div>
                                        </div>
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq3" class="faq-question">¿Cómo agrego un
                                            nuevo proveedor?</a>
                                        <small>Tipo: <strong>Funciones</strong></small>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div id="faq3" class="panel-collapse collapse ">
                                            <div class="faq-answer">
                                                <p>
                                                    Diríjase a "Proveedores" en el menú de la izquierda, cliqueelo y en
                                                    la
                                                    parte inferior de la tabla de proveedores presione "agregar" y
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq4" class="faq-question">¿Cómo modifico mi
                                            contraseña?</a>
                                        <small>Tipo: <strong>Funciones</strong></small>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div id="faq4" class="panel-collapse collapse ">
                                            <div class="faq-answer">
                                                <p>
                                                    Al ser usuario administrador hay dos maneras de modificar sus datos
                                                    personales:
                                                </p>
                                                <p>
                                                    1. Dirigiéndose a "Ajustes de usuario" en el menú de la izquierda,
                                                    seleccionando
                                                    "Gestión de usuarios" en el menú desplegable, cliquear la fila con
                                                    sus datos, luego
                                                    cliquear el botón "modificar" en la parte inferior de la tabla de
                                                    usuarios registrados.
                                                </p>
                                                <p>

                                                    2. Dirigéndose a "Ajustes de usuario" en el menú de la izquierda,
                                                    seleccionando
                                                    "Gestión de perfil" en el menú desplegable y cliqueando el botón de
                                                    "cambiar contraseña"
                                                </p>
                                            </div>
                                        </div>
